...
COMPRESS_ROOT = '/openstack/venvs/horizon-14.1.0/lib/python2.7/dist-packages/static'
...
SECRET_KEY = "82b497d7cabcc3d00fe39a0a"
...
CACHES = {
    'default': {
        ...
        'LOCATION': [u'172.29.239.123:11211']
    }
}
...
DATABASES = {
    'default': {
        ...
        'NAME': 'horizon',
        'USER': 'horizon',
        'PASSWORD': 'e654853a2e5c9786ab60163705ed0b87d7b4cc5d1f',
...
OPENSTACK_HOST = "172.29.236.51"
OPENSTACK_KEYSTONE_URL = "http://172.29.236.51:5000/v3"
...
SWIFT_FILE_TRANSFER_CHUNK_SIZE = 524288
